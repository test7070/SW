        ...
        <script type="text/javascript">    
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                //q_box('freefield_s.aspx', q_name + '_s', "500px", "350px", q_getMsg("popSeek"));
            }
            ...
            function btnOk() {
                Lock(1,{opacity:0});
            	var t_err = '';
                t_err = q_chkEmpField([['txtFields', q_getMsg('lblFields')],['txtMemo', q_getMsg('lblMemo')]]);
			...
			<div class="dview" id="dview" style="float: left; "  >
				<table class="tview" id="tview"   border="1" cellpadding='2'  cellspacing='0' style="background-color: #FFFF66;">
					<tr>
						...
						<td align="center" style="width:95%"><a id='vewFields'> </a></td>
					</tr>
					<tr>
						<td ><input id="chkBrow.*" type="checkbox" style=''/></td>
						<td align="center" id="fields">~fields</td>
					</tr>
				</table>
			</div>
			<div class='dbbm' style="float: left;">
				<table class="tbbm"  id="tbbm"   border="0" cellpadding='2'  cellspacing='5'>
					...
					<tr>
						...
						<td colspan="3"><textarea id="txtMemo" cols="10" rows="5" style="width: 99%;height: 100px;"> </textarea></td>
						<td> </td>
					</tr>
					<tr>
