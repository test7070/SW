...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            function mainPost() {
                q_getFormat();
                bbmMask = [['txtBirthday', '9999/99/99'],['txtIndate', '9999/99/99'],['txtOutdate', '9999/99/99']];
                q_mask(bbmMask);
			...
			<div class='dbbm'>
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td colspan="3"><input id="txtAddr_home"  type="text" class="txt c1"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan="3"><input id="txtSchool" type="text" class="txt c1"/></td>
					</tr>
					<tr>
