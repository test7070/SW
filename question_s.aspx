	...
	<head>
		...
		<script type="text/javascript">
			...
			function q_gfPost() {
				...
				q_mask(bbmMask);
				q_cmbParse("cmbTypea",'@全部,'+q_getPara('question.typea'));
			}
	...
	<body>
		<div style='width:400px; text-align:center;padding:15px;' >
			<table id="seek"  border="1"   cellpadding='3' cellspacing='2' style='width:100%;' >
				...
				<tr class='seek_tr'>
					<td class='seek' style="width:30%;"><a id='lblEmail'> </a></td>
					<td><input class="txt" id="txtEmail" type="text" style="width:215px; font-size:medium;" /></td>
				</tr>
				<tr class='seek_tr'>
