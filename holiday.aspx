		...
		<script type="text/javascript">
            ...
            function _btnSeek() {
                if (q_cur > 0 && q_cur < 4)// 1-3
                    return;
                q_box('holiday_s.aspx', q_name + '_s', "500px", "300px", q_getMsg("popSeek"));
            }
            ...
            function readonly(t_para, empty) {
                ...
                if (t_para) {
					...
					$('#txtNoa').datepicker({ dateFormat: 'yy/mm/dd' });
				}
            }
			...
			<div class="dview" id="dview">
				<table class="tview" id="tview">
					...
					<tr>
						...
						<td id='memo,10' style="text-align: center;">~memo,10</td>
					</tr>
				</table>
			</div>
			<div class='dbbm'>
